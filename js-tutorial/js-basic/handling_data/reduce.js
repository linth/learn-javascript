...
var reduceEmpty = people.reduce((accumularor, currentValue, currentIndex, arr) => {

});

var reducePlus = people.reduce((accumularor, currentValue, currentIndex, arr) => {
  console.log('accumularor', accumularor, 'currentValue', currentValue, 'currentIndex', currentIndex);
  return accumularor + currentValue.age;
}, 0);

var reducePlus = people.reduce((accumularor, currentValue, currentIndex, arr) => {
  console.log('accumularor', accumularor, 'currentValue', currentValue, 'currentIndex', currentIndex);
  return Math.max(accumularor, currentValue.age);
}, 0);

console.log('reducePlus', reducePlus);